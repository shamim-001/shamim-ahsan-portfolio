      ...
      <section className="bg-gradient-to-b from-white to-blue-50 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
            Have questions about my services or ready to improve your local SEO? I'm here to help.
          </p>
        </div>
      </section>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:theshamimahsan@gmail.com" className="text-primary hover:underline">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="tel:+8801749181410" className="text-primary hover:underline">
                          +8801749181410
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">52/6, Mujahid Nagar, Old Passport Road, Dhaka-1362</p>
                      </div>
                    </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4">
          ...
          <div className="h-[400px] rounded-lg overflow-hidden shadow-lg">
            ...
            >
              <GoogleMap latitude={23.6971398} longitude={90.4595524} zoom={15} />
            </Suspense>
          </div>
        </div>
      </section>
